...
model.save_weights('./_save/keras26_17_save_weights2.h5')
# model.load_weights('./_save/keras26_16_save_weights2.h5')
...
# model.load_weights('./_save/keras26_15_save_weights2.h5')
# model = Sequential()
# model.add(Conv1D(10, 2, input_shape=(3,1))) #토탈:141
# model.add(Conv1D(10, 2))                   #토탈:301 conv1d는 conv2d와 파라미터 계산식 같음
# model.add(Flatten())
