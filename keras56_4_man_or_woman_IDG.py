...
path = 'd:/study_data/_data/man-or-woman/'
save_path = 'd:/study_data/_save/man-or-woman/'
...
xy_train = train_datagen.flow_from_directory(
    'd:/study_data/_data/man-or-woman/',                        
     target_size=(150,150),                
     batch_size=1665,                  #전체데이터쓸려면 160(전체데이터갯수) 이상 넣으면 됨
...
x_train,x_test,y_train,y_test = train_test_split(xy_train[0][0], xy_train[0][1] , train_size=0.7, shuffle=True, random_state=42)
...
np.save(save_path + 'keras56_7_x_train.npy', arr = x_train)
