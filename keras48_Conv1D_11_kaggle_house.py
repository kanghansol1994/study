...
x_train, x_test, y_train, y_test = train_test_split(
    x, y, train_size = 0.9, shuffle = True, random_state = 221)
scaler = MinMaxScaler()
scaler.fit(x_train)
...
mcp = ModelCheckpoint(monitor='val_loss',
                      mode='auto',
                      verbose=1,
                      filepath=''.join([filepath+'0501'+date+'_'+filename])
                      )
...
submission.to_csv('./_save/kaggle_house/03230501'+date+'.csv')

#RNN
# loss : [182528.015625, 182528.015625]
# r2스코어 : -4.149966775636756

#Conv1D
# loss : [182148.796875, 182148.796875]
# r2스코어 : -4.13266336944067