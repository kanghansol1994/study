...
x1_train = x1_train.reshape(143, 160)
x1_test = x1_test.reshape(36, 160)
x2_train = x2_train.reshape(143, 160)
x2_test = x2_test.reshape(36, 160)
...
x1_train = x1_train.reshape(143, 20,8)
x1_test = x1_test.reshape(36, 20,8)
x2_train = x2_train.reshape(143, 20,8)
x2_test = x2_test.reshape(36, 20,8)



#2. 모델구성
input1 = Input(shape=(20,8))
dense1 = Conv1D(150, 4, activation='relu', name='hyundae1')(input1)
dense2 = Conv1D(150, 4, activation='relu', name='hyundae2')(dense1)
dense3 = Flatten(name = 'flatten1')(dense2)
dense4 = Dense(10)(dense3)
dense5 = Dense(20, activation='relu', name='hyundae3')(dense4)
dense6 = Dropout(0.5)(dense5)
output1 = Dense(10, activation='relu', name='output1')(dense6)

#2. 모델2
input2 = Input(shape=(20, 8))
dense11 = Conv1D(150, 4 , activation='relu', name='samsung1')(input2)
dense12 = Conv1D(150, 4 , activation='relu', name='samsung2')(dense11)
dense13 = Flatten(name = 'flatten2')(dense12)
dense14 = Dense(10, activation='relu', name='samsung3')(dense13)
dense15 = Dense(20, activation='relu', name='samsung4')(dense14)
dense16 = Dense(40, activation='relu', name='samsung5')(dense15)
dense17 = Dropout(0.5)(dense16)
output2 = Dense(10, activation='relu', name='output2')(dense17)
...
last_output = Dense(1, activation='linear', name='last')(merge4)
...
model.load_weights(path_save + 'keras53_samsung4_khs.h5')
