...
model.fit([x1_train,x2_train],y_train, epochs=300, batch_size=8, verbose=1)
#4. 평가, 예측
...
################################################
# loss =  0.003978469409048557
# r2스코어 =  0.9999932589133977
# RMSE :  0.0630751097592127

# loss =  8.404254913330078e-06
# r2스코어 =  0.9999999857598982
# RMSE :  0.0028990092985932414