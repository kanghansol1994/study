...
xy_train = train_datagen.flow_from_directory(
    'd:/study_data/_data/horse-or-human/',                        
     target_size=(150,150),                
     batch_size=1027,                  #전체데이터쓸려면 160(전체데이터갯수) 이상 넣으면 됨
...
np.save(save_path + 'keras56_3_x_train.npy', arr = x_train)
np.save(save_path + 'keras56_3_x_test.npy', arr = x_test)
np.save(save_path + 'keras56_3_y_train.npy', arr = y_train)
np.save(save_path + 'keras56_3_y_test.npy', arr = y_test)
