...
from tensorflow.keras.layers import Dense,LeakyReLU,Dropout,MaxPooling2D,Flatten,Input,Conv2D
...
submission.to_csv('./_save/kaggle_house/submit_0501'+date+'.csv')
