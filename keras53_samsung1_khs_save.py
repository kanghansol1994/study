...
y = y[:300][::-1]
x2 = x2[:300][::-1]
# print(x1.shape) #(365, 8)
# print(x2.shape) #(365, 8)
# print(samsung_y.shape) #(365, 1)
...
x1_train = x1_train.reshape(224, 160)
x1_test = x1_test.reshape(56, 160)
x2_train = x2_train.reshape(224, 160)
...
x1_train = x1_train.reshape(224, 20,8)
x1_test = x1_test.reshape(56, 20,8)
x2_train = x2_train.reshape(224, 20,8)
...
dense11 = LSTM(10, return_sequences=True, activation='relu', name='huyndae1')(input2)
dense12 = Dense(20, activation='relu', name='hyundae2')(dense11)
dense13 = Conv1D(20, 4, activation='relu', name='conv1d2')(dense12)
dense14 = Flatten(name = 'flatten1')(dense13)
dense15 = Dense(128, activation='relu', name='hyundae3')(dense14)
dense16 = Dense(64, activation='relu', name='hyundae4')(dense15)
dense17 = Dense(32, activation='relu', name='hyundae5')(dense16)
output2 = Dense(100, activation='relu', name='output2')(dense17)
...
model.save(path_save + 'keras53_samsung2_khs.h5')
